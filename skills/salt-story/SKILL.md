...
1. **🔥 古代言情/重生**（盐选最大流量池！）— 重生反杀、追夫火葬场、宫斗逆袭（代表：《飞蛾欲火》4719赞，机构号"宫墙往事"449万粉）
   - **注意：高流量 = 高竞争。** 这条赛道不能只做到“有钩子”，必须做到“免费段就能压住编辑”。
   - 重点自检：
     - 开头 1500 字内，女主是否有**切肤代价**，而不只是“帅气动作”？
     - 标题动作（如逃婚/泼酒/退婚）之后，是否立刻进入**更大的现实危机**？
     - 反派是否足够强，能让女主的赢显得值钱？
...
5. **死人文学/追悔文** — 主角将死/已死，众人追悔莫及（虐中带爽）
6. **婚恋情感** — 但必须带悬疑/反转钩子+爽感，**不能写纯催泪**
7. **底层叙事/成长逆袭** — 高难度但天花板最高（代表：《温泉街》7600赞）
8. **职场逆袭** — 被欺负的小人物翻盘，PUA复仇
9. **悬疑推理** — 不可靠叙述者、多层真相
...
- 尤其是**古言重生/大婚前夜/追夫火葬场**这类高竞争题材，最容易犯的错就是：女主知道未来 → 每一步都踩对 → 对手像木桩。
- **时间线太顺 = 逻辑显假 = 代入感断裂**。读者会立刻问：她为什么这么顺？别人为什么这么蠢？
- 硬性要求：
  1. 主角至少有 **1 次判断失误/计划偏差**；
  2. 反派/男主/家族必须有 **真实反扑**，不能一推就倒；
  3. 关键节点必须有 **代价**（名声、婚约、盟友、资源、身体风险至少其一）；
  4. 免费部分不能只靠“我重生了所以我知道”，必须靠 **当下动作 + 当下危机** 立住。
...
- 开头的炸点必须对应**现实后果**，不能只有姿态没有代价。
- 如果标题是“泼酒/退婚/掀桌/逃婚”这类强动作，正文前1500字必须回答：
  1. 她为什么必须现在做？
  2. 她不这么做会失去什么？
  3. 做完之后她立刻会面对什么新的危险？
- 任何一条答不清，编辑都会觉得“动作很猛，但人不真，代入不进去”。
...
| 人物不出彩/代入感弱 | 主角有没有具体缺陷？有没有让人共情的困境？有没有“现在不做就完了”的切肤代价？ |
| 叙事节奏较慢        | 前4000字有没有至少3个钩子/转折？                                             |
| 叙事较平/转折不突出 | 有没有A级反转？伏笔是否铺设？                                                |
| **时间线太顺**      | 主角是否至少失手一次？反派是否真实反扑？关键节点是否付出代价？               |
| 同类内容较多        | 有没有差异化角度？换个视角、换个设定？高竞争赛道是否强到值得编辑继续看？     |
