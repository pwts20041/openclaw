...
- Providers/DeepInfra: add DeepInfra as an official provider with interactive onboarding, `DEEPINFRA_API_KEY` auto-detection, and dynamic model discovery from the DeepInfra API.
