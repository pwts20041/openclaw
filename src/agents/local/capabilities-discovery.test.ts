...
describe("Local Capabilities Discovery", () => {
  describe("Reasoning model detection", () => {
    it("identifies deepseek-r1 as a reasoning model", () => {
      const result = discoverLocalCapabilities({ modelId: "deepseek-r1:32b", providerType: "ollama" });
    ...
    it("identifies qwq as a reasoning model", () => {
      const result = discoverLocalCapabilities({ modelId: "Qwen/QwQ-32B-Preview", providerType: "lmstudio" });
      expect(result.isReasoningModel).toBe(true);
  ...
  describe("Tool format detection", () => {
    it("assigns ollama-dsl to known tool-capable Ollama models", () => {
      const result = discoverLocalCapabilities({ modelId: "qwen2.5-coder:32b", providerType: "ollama" });
    ...
    it("assigns openai format to known tool-capable LMStudio models", () => {
      const result = discoverLocalCapabilities({ modelId: "llama-3.3-70b-instruct", providerType: "lmstudio" });
